...
### ✍️ 灵动编辑
- **所见即所得编辑**：实时渲染的排版更符合移动端创作直觉，支持平滑切换编辑与预览状态。
...
```bash
# 1. 克隆仓库
git clone https://github.com/zeng-eh/PureMD.git
...
也可以在 [Discussions](https://github.com/zeng-eh/PureMD/discussions) 中分享你的使用场景或设计灵感。
...
---
<p align="center">
  <small>Made with ❤️ by <a href="https://github.com/zeng-eh">zeng-eh</a> and the PureMD community</small>
</p>
